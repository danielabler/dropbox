...
def main():
    ...
    if args.token:
        print("Using user-token to authenticate.")
        dbx = dropbox.Dropbox(args.token)
    else:
        print("Please follow instructions to authenticate:")
        dbx = authorize_app(APP_KEY="fqzkbwry736q6kv", APP_SECRET="w85rkm7aj7e8u1h")
